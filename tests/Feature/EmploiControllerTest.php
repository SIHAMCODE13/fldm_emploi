...
class EmploiControllerTest extends TestCase
{
    ...
    /** @test */    public function it_can_display_index()
    {
        ...
        $response->assertViewHas('emplois');
    }

    /** @test */    public function it_can_store_emploi()
    {
        $filiere = Filiere::factory()->create();
        $groupe = Groupe::factory()->create(['id_filiere' => $filiere->id_filiere]);
        $semestre = Semistre::factory()->create();
        ...
        $this->assertDatabaseHas('seances', ['jour' => 'lundi', 'debut' => '08:00', 'fin' => '10:00']);
    }

    /** @test */    public function it_can_destroy_seance()
    {
    ...
    /** @test */    public function it_can_update_seance()
    {
        $seance = Seance::factory()->create();

        $data = [
            'type_seance' => 'TD',
            'id_salle' => Salle::factory()->create()->id_salle,
            'user_id' => User::factory()->create(['id_role' => 2])->id,
            'id_module' => Module::factory()->create()->id_module,
        ];
        ...
        $this->assertDatabaseHas('seances', ['type_seance' => 'TD']);
    }

    /** @test */    public function non_admin_cannot_access_emplois_index()
    {
